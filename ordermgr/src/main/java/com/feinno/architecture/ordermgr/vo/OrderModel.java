...
public class OrderModel extends BaseModel{
	...
	public String toString(){
		return "Model"+this.getClass().getName()+"[uuid=" + this.getUuid() + ",customerUuid=" + this.getCustomerUuid() + ",orderTime=" + this.getOrderTime() + ",totalMoney=" + this.getTotalMoney() + ",saveMoney=" + this.getSaveMoney() + ",state=" + this.getState() + ",]";
	}	
}
