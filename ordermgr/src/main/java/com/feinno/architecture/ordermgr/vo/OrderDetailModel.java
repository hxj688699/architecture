package com.feinno.architecture.ordermgr.vo;
...
public class OrderDetailModel extends BaseModel{
	...
	public String toString(){
		return "Model"+this.getClass().getName()+"[uuid=" + this.getUuid() + ",orderUuid=" + this.getOrderUuid() + ",goodsUuid=" + this.getGoodsUuid() + ",orderNum=" + this.getOrderNum() + ",price=" + this.getPrice() + ",money=" + this.getMoney() + ",saveMoney=" + this.getSaveMoney() + ",]";
	}	
}
