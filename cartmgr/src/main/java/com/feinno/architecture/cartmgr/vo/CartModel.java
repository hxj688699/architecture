package com.feinno.architecture.cartmgr.vo;
...
public class CartModel extends BaseModel{
	...
	public String toString(){
		return "Model"+this.getClass().getName()+"[uuid=" + this.getUuid() + ",customerUuid=" + this.getCustomerUuid() + ",goodsUuid=" + this.getGoodsUuid() + ",buyNum=" + this.getBuyNum() + ",]";
	}	
}
